...
import { dernierEtatConnu, lireCompte, noterApresComposition, retenirEtat, } from '../src/compte.js';
...
describe('lire le compte', () => {
    it('présente l’appareil à chaque requête', async () => {
        ...
        expect(options.headers.authorization).toMatch(/^Appareil [0-9a-f]{32}$/);
    });
