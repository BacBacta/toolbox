...
export function strategiePour(requete, origine) {
    ...
    if (url.origin !== origine)
        return 'reseau';
    if (CHEMINS_SERVEUR.some((prefixe) => url.pathname.startsWith(prefixe)))
        return 'reseau';
 ...
 */
export function fichiersAPrecacher(emis) {
